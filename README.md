...
-list with n numbers, with varying degrees of presortedness, specifics can be defined. accuracy of presortedness level decreases with higher specification
